  ...
  useEffect(() => {
    ...
    async function loadTransactions(): Promise<void> {
      api.get('transactions').then((result) => {
        ...
        const transactionsFormated = result.data.transactions.map((transaction: Transaction) => ({
          ...transaction,
        ...
        const balanceFormated: Balance = {
          income: formatValue(result.data.balance.income),
          outcome: formatValue(result.data.balance.outcome),
          total: formatValue(result.data.balance.total),
        }
